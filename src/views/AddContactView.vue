        ...
        <div class="content">
            <div class="form">
                <form @submit.prevent="addContact">
                    ...
                    <input type="text" placeholder="Numero..." v-model="formContact.numero">
                    <span class="error" v-if="errorShort">Le numero doit faire au moins 10 chiffres</span>
                    <span class="error" v-if="errorTaken">Le numero est deja enregistré</span>
...
export default {
    ...
    methods: {
        addContact() {
            ...
            if(this.contacts.find(contact => contact.numero == this.formContact.numero)) {
