        ...
        <div class="content">
            ...
            <div class="contacts">
                <div class="contactDiv">
                    <h2>Contact</h2>
                    <router-link to="/addContact" class="plusIcon">
                        <img src="../assets/plus_icon.png" alt="plus icon">
                    </router-link>
                </div>

                <div class="contact" v-for="contact in contacts" :key="contact.numero">
                    <h2>{{ contact.nom }}</h2>
                    <span>{{ contact.numero }}</span>
                    <img src="../assets/phone.png" alt="" @click="addJournal(contact)" class="imgAppel">
                </div>
...
export default {
    ...
    methods: {
        addJournal(contact) {
            this.formJournal.nom = contact.nom
            this.formJournal.numero = contact.numero
            const date = new Date()
